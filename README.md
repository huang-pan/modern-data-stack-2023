...
2. Take courses to refresh / update my data engineering skills:
	...
	- [Azure Data / ML Engineer, MlOps, Terraform, Kubernetes, etc.](https://github.com/huang-pan/modern-data-stack-2023/blob/main/Azure_Data-ML_Engineer%2C_MLOps%2C_Kubernetes%2C_Terraform%2C_Streamlit.md)
...
- The Udemy Azure and Databricks courses were very helpful for understanding the latest Databricks offerings on Azure. Services of note are: Unity Catalog, Delta Live Tables, Databricks CI/CD.
