...
**NOTE**: the [author](https://www.linkedin.com/in/huangpan/) tries his best to keep up with the latest advances in data & AI in order to apply them on the job. This GitHub repo contains a summary of his efforts and attempts to be a comprehensive overview of all the available technologies in data infrastructure & engineering and AI (as it relates to intelligent data systems - context engineering / semantic models / ontologies, AI driven development / agent harnesses, etc.). The below lists all the related certifications the author has accrued in these technologies.
